...
var ca = <Language> {
    ...
    warning_text_1: "Escriu les paraules en l'ordre correcte i guarda-les en un lloc segur (offline). Si perds aquestes paraules, no podrás accedir als teus bitcoins.",
